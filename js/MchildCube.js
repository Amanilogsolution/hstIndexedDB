...
function removeDuplicates(data) {
  ...
  childCubeArray.push(`
    ...
    <div class="card">
      <div class="card-body-mccube">
          <div class="row">
            <div class="col bg-danger m-1" onclick="packData(${childCube[24]['CC_NO']})">
            ${childCube[24]['CC_NO']},${childCube[24]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[25]['CC_NO']})">
            ${childCube[25]['CC_NO']},${childCube[25]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[26]['CC_NO']})">
            ${childCube[26]['CC_NO']},${childCube[26]['CC_NAME']}
            </div>
            
          </div>
          <div class="row">
            <div class="col bg-danger m-1" onclick="packData(${childCube[27]['CC_NO']})">
            ${childCube[27]['CC_NO']},${childCube[27]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[28]['CC_NO']})">
            ${childCube[28]['CC_NO']},${childCube[28]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[29]['CC_NO']})">
            ${childCube[29]['CC_NO']},${childCube[29]['CC_NAME']}
            </div>
            
          </div>
          <div class="row">
            <div class="col bg-danger m-1" onclick="packData(${childCube[30]['CC_NO']})">
            ${childCube[30]['CC_NO']},${childCube[30]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[31]['CC_NO']})">
            ${childCube[31]['CC_NO']},${childCube[31]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[32]['CC_NO']})">
            ${childCube[32]['CC_NO']},${childCube[32]['CC_NAME']}
            </div>
          
          </div> 
          <div class="row">
            <div class="col bg-danger m-1" onclick="packData(${childCube[33]['CC_NO']})">
            ${childCube[33]['CC_NO']},${childCube[33]['CC_NAME']}
            </div>
            <div class="col bg-danger m-1" onclick="packData(${childCube[34]['CC_NO']})">
            ${childCube[34]['CC_NO']},${childCube[34]['CC_NAME']}
            </div>
            
            <div class="col bg-danger m-1" onclick="packData(${childCube[35]['CC_NO']})">
